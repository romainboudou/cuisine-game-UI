...
public class ObjectContainuable : MonoBehaviour
{
    [Header("Highlight Settings")]
    [SerializeField] private Camera playerCamera;
    [SerializeField] private float maxDistance = 5f;
    [SerializeField] private LayerMask containuableLayer;
    ...
    [Header("Hand Manager")]
    [SerializeField] private HandManager handManager; // Référence au HandManager
    ...
    private void HandleHighlight()
    {
        ...
        if (Physics.Raycast(ray, out hit, maxDistance, containuableLayer))
        {
